...
const TechnologyLogos = () => {
  return (
    <div className="relative z-50 flex flex-col justify-center gap-1 px-4 py-2 drop-shadow-2xl md:flex-row md:gap-24">
      <div className="flex justify-center gap-8 md:gap-24">
        <AnimateIn>
          <div className="mt-4 w-12 md:mt-10 md:w-20">
            <svg
