...
const CourseCard = ({ course }: { course: Course }) => {
  return (
    <article
      ...
      className={`testing-card-safari course-card ${course.type}-course-card flex flex-col justify-center overflow-hidden py-4 px-8 text-center drop-shadow-2xl md:px-20`}
    >
